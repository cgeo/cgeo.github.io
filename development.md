...
If you would like to contact the developers directly you can join our IRC channel [#cgeo on freenode.net](https://webchat.freenode.net/?channels=%23cgeo). Be aware that it might take some time until someone can respond to your question, most activity happens in the evening (European time zones).

## Our website

Like our application also this website is open source and is hosted on [Github](https://github.com/cgeo/cgeo.github.io).
...
Nightly builds are not for normal usage, as they contain code that is not well tested yet. You should only install these versions if you know what you're doing.

If you install a nightly build to your device, you may experience crashes or missing functionality. Please report such bugs, but don't expect us to deliver a fix right afterwards. If you need stable functionality, use the normal build please.
...
If you want to contribute translations you are invited to do so on this platform! Just create a free account on [Crowdin](https://crowdin.com/) and start contributing translations or vote for existing proposals to the [c:geo Crowdin Project](https://crowdin.com/project/cgeo).
